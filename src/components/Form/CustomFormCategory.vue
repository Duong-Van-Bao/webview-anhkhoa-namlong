            ...
            <template v-for="items in Object.keys(dataForm)" v-if="Object.keys(dataForm).length > 0">
              <template v-if="items.toUpperCase().search('NOTE') === -1 && items.toUpperCase().search('DESCRIPTION') === -1">
                <b-colxx md="6">
                  ...
                  <template v-else-if="dataForm[items][2].toUpperCase() === 'SELECT-TREE'">
                    <b-form-group :label="dataForm[items][0]">
                      <treeselect
                        :multiple="false"
      ...
      checkFormValidityModal() {
        ...
        for (let i = 0; i < Object.keys(this.dataForm).length; i++){
          if (Object.keys(this.dataForm)[i].toUpperCase().search('NOTE') === -1 && Object.keys(this.dataForm)[i].toUpperCase().search('DESCRIPTION') === -1) {
            if (this.dataForm[Object.keys(this.dataForm)[i]][2].toUpperCase() !== 'SELECT' && this.dataForm[Object.keys(this.dataForm)[i]][2].toUpperCase() !== 'SELECT-TREE'
              && this.dataForm[Object.keys(this.dataForm)[i]][2].toUpperCase() !== 'DATE' && this.dataForm[Object.keys(this.dataForm)[i]][2].toUpperCase() !== 'BIT' && this.dataForm[Object.keys(this.dataForm)[i]][2].toUpperCase() !== 'KEY') {
