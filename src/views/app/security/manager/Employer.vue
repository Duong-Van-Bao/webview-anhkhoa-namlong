    ...
    methods: {
      ...
      editModal(items) {
        ...
        setTimeout(() => {
          ...
          this.idForm = items[0].EmployerID
          setTimeout(() => {
            this.$bvModal.show(this.nameForm)
          }, timer)
        }, timer)
      ...
      deleteModal(items) {
        this.$bvModal.msgBoxConfirm(this.$t('form.question') + items[0].EmployerName + '?', {
      ...
      async handleSubmitDelete(id) {
        ...
        methods.post("/api/Employers/Delete", body).then(val => {
          if (val !== null && val !== '' && val !== undefined && val.StatusCode === 200 && val.Success === 1) {
      ...
      resetPassModal(items) {
        this.$bvModal.msgBoxConfirm(this.$t('form.question-pass') + items[0].EmployerName + '?', {
          title: this.$t('form.warning').toUpperCase(),
          size: 'sm',
          buttonSize: 'sm',
          okVariant: 'danger',
      ...
      async handleSubmitResetPass(id) {
        ...
        methods.post("/api/Employers/ResetPassword", body).then(val => {
          if (val !== null && val !== '' && val !== undefined && val.StatusCode === 200 && val.Success === 1) {
            this.getData()
            setTimeout(() => {
              this.makeToast('success', this.$t('toast.success').toUpperCase(), val.Message)
      ...
      statusEdit(data) {
        ...
        methods.post("/api/Employers/ChangeStatus", body).then(val => {
          if (val !== null && val !== '' && val !== undefined && val.StatusCode === 200 && val.Success === 1) {
            setTimeout(() => {
              this.getData()
              this.makeToast('success', this.$t('toast.success').toUpperCase(), val.Message)
      ...
      getDataByID(id) {
        ...
        methods.post("/api/Employers/GetEmployerById", body).then(val => {
          if (val !== null && val !== '' && val !== undefined && val.StatusCode === 200 && val.Success === 1) {
      ...
      getData() {
        methods.post("/api/Employers/GetEmployerList", {}).then(val => {
          if (val !== null && val !== '' && val !== undefined && val.StatusCode === 200 && val.Success === 1) {
